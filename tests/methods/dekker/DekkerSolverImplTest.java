...
import br.edu.ufcg.msnlab.methods.dekker.DekkerException;
 ...
 */
public class DekkerSolverImplTest extends TestCase {

    private DekkerSolver dekker;
    ...
    private void assertEquals(String function, Map<String, String> variableToValue, double lowerBound,
	    double upperBound, double expectedValue) throws DekkerException, InvalidFunctionException {
	...
	List<DekkerResult> result = dekker.solve(new FunctionImpl(function), lowerBound, upperBound, tol);
    ...
    private Double last(List<DekkerResult> list) {
