...
import br.edu.ufcg.msnlab.methods.bus.BusAlgorithmMException;
 ...
 */
public class BusAlgorithmMSolverImplTest extends TestCase {

    private BusAlgorithmMSolver algorithmM;
	...
	super.setUp();
	algorithmM = new BusAlgorithmMSolverImpl();
	function = null;
	expectedValue = null;
	receivedValue = null;
    }
	...
	try {
	    ...
	    fail();
	} catch (BusAlgorithmMException e) {
	}
    ...
    private void assertEquals(String function, Map<String, String> variableToValue, double lowerBound,
	    double upperBound, double expectedValue) throws BusAlgorithmMException, InvalidFunctionException {
	...
	List<BusAlgorithmMResult> result = algorithmM.solve(new FunctionImpl(function), lowerBound, upperBound, tol);
    ...
    private Double last(List<BusAlgorithmMResult> list) {
