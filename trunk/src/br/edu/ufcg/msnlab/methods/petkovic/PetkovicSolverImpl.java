...
public class PetkovicSolverImpl implements PetkovicSolver {
	 ...
	 */
    public List<PetkovicResult> petkovic(Function g, double guess, double tolerance, double maxIterations){
...
//        return results;
	 ...
	 */
    public List<PetkovicResult> solve(Function function, double tolerance) {
