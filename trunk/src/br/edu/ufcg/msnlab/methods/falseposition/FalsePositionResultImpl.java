 ...
 *
 */
public class FalsePositionResultImpl implements FalsePositionResult {

	private double x;
	private double max;
	private double min;

	public FalsePositionResultImpl(double min,
			double max, double x) {
		setMin(min);
		setMax(max);
		setX(x);
	...
	/* (non-Javadoc)
	 * @see methods.FalsePositionResult#getMax()
	 */
	...
	/* (non-Javadoc)
	 * @see methods.FalsePositionResult#getMin()
	 */
