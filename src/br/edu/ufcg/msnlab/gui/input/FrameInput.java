            ...
            if (method.equals(Methods.BISECTION)) {
                ...
                if (fieldGuess.getText().trim().equals("")) {
                    ...
                    try {
                        ...
                        if (iterations == 0) {
                            result = bs.solve(function, new FunctionImpl(fieldItFunction.getText()), guess, tolerance);
                        } else {
                            result = bs.solve(function, new FunctionImpl(fieldItFunction.getText()), guess,
